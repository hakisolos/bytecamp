    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (response.status === 409) {
                const message = data.message || 'A user with this username or email already exists';
            ...
            if (response.status === 401) {
                const message = data.message || 'Please fill in all fields correctly';
                showNotification(message, true);
                setIsLoading(false);
                return;
            }
        ...
        <div className="min-h-screen bg-gray-950 flex items-center justify-center p-4 sm:p-6 lg:p-8 relative overflow-hidden">
            ...
            <div className="w-full max-w-md relative z-10">
                ...
                <p className="text-center text-xs sm:text-sm text-gray-500 mt-4 sm:mt-6">
                    By creating an account, you agree to ByteCamp's{' '}
